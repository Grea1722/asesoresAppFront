...
const Pedido = ({ pedido }) => {
  ...
  //funcion para modificar color de pedido
  const clasePedido = () => {
  ...
  return (
    ...
    >
      <div>
        ...
        <select
          className="mt-2 appearance-none bg-blue-600 border border-blue-600 text-white p-2 text-center rounded leading-tight focus:outline-none focus-bg-blue-600 focus:border-blue-500 uppercas text-xs font-bold"
          value={estadoPedido}
